...
function scss(cb) {
    return buildStyles(
        {
            src: [
                "./src/blocks/fonts.scss",
                "./src/blocks/icons.scss",
                "./src/blocks/common/index.scss",
                // "./src/blocks/common/**/*.scss",
                // "./src/blocks/pages/**/*.scss",
            ],
            dest: './dist',
...
function serve(cb) {
    watch("./src/**/*.scss", scss);
    watch("./src/fonts/**/*.{woff,woff2,ttf,eot}", fonts);
    watch("./src/assets/images/**/*.{png,jpg,svg}", images);
    watch("./src/**/*.pug", pug);
    watch("./src/**/*.js", js);
